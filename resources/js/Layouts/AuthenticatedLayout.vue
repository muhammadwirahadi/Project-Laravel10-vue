            ...
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="shrink-0 flex items-center">
                                ...
                                <span class="m-2 text-xs text-gray-700">Mahkama Agung Republic Indonesia <br> Direktorat Jendral Badan Peradilan Agama</span>
                            </div>
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink :href="route('lowongan.index')" :active="route().current('lowongan.index')">
                                    Lowongan
                                </NavLink>
                ...
                >
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink :href="route('lowongan.index')" :active="route().current('lowongan.index')">
                            Lowongan
                        </ResponsiveNavLink>
